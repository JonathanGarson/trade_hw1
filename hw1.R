...
# # writeLines(as.character(fmp_table), "fmp_table.typ")
# 
# phi_hat_coef_ols = model_fmp$OLS$coefficients[["log(distw)"]] + model_fmp$OLS$coefficients[["contig"]] +
#   model_fmp$OLS$coefficients[["comlang_off"]] + model_fmp$OLS$coefficients[["comcur"]] +
#   model_fmp$OLS$coefficients[["fta_wto"]]
# 
# phi_hat_coef_pois = model_fmp$Poisson$coefficients[["log(distw)"]] + model_fmp$Poisson$coefficients[["contig"]] +
#   model_fmp$Poisson$coefficients[["comlang_off"]] + model_fmp$Poisson$coefficients[["comcur"]] +
#   model_fmp$Poisson$coefficients[["fta_wto"]]
# 
# fmp_fe_ols = fixef(model_fmp$OLS)$iso_d
# fmp_fe_pois = fixef(model_fmp$Poisson)$iso_d
# 
